...
const I18N = {
  ru: {
    ...
    law2Text:
      "Статья 16 требует открыто разместить сведения об арбитраже, юридический адрес, регламент и реестр арбитров. Решения — только с согласия сторон. Регламент опубликован отдельной страницей; полный адрес и реестр дополняются после государственной регистрации и утверждения состава.",
    ...
    regLead:
      "Постоянно действующий арбитраж обязан открыто публиковать наименование, юридический адрес, регламент и реестр арбитров. Пока юридическое лицо не зарегистрировано и реестр не утверждён, на сайте указываем то, что уже можно раскрыть без вымысла.",
    ...
    reg2Text: "Республика Казахстан. Полный юридический адрес будет опубликован сразу после государственной регистрации — без адреса статья 16 не исполнена до конца.",
    reg3Title: "Регламент",
  ...
  kk: {
    ...
    law2Text:
      "16-бап төрелік туралы мәліметті, заңды мекенжайды, регламентті және төрешілер тізілімін ашық орналастыруды талап етеді. Шешімдер — тек тараптар келіскенде. Регламент жеке бетте; толық мекенжай мен тізілім тіркеуден және құрам бекітілгеннен кейін толықтырылады.",
    ...
    regLead:
      "Тұрақты төрелік атауын, заңды мекенжайын, регламентін және төрешілер тізілімін ашық жариялауға міндетті. Заңды тұлға тіркеліп, тізілім бекітілгенге дейін сайтта шынайы мәлімет қана көрсетіледі.",
    reg1Title: "Атауы",
    reg1Text: "Justitia халықаралық коммерциялық төрелігі (MKAJ). Бұл төреліктің атауы, соттың емес.",
    reg2Title: "Заңды мекенжайы",
    reg2Text: "Қазақстан Республикасы. Толық заңды мекенжай мемлекеттік тіркеуден кейін бірден жарияланады — мекенжайсыз 16-бап толық орындалмайды.",
    reg3Title: "Регламент",
  ...
  en: {
    ...
    law2Text:
      "Article 16 requires public disclosure of the arbitration’s details, its legal address, its rules and the list of arbitrators. Awards — only with the parties’ consent. The rules are on a separate page; the full address and the list will be added after state registration and approval of the panel.",
    ...
    regLead:
      "A permanent arbitration must publish its name, legal address, rules and list of arbitrators. Until the legal entity is registered and the list is approved, this site states only what can be disclosed without invention.",
    reg1Title: "Name",
    ...
    reg2Text: "Republic of Kazakhstan. The full legal address will be published immediately after state registration — without it Article 16 is not fully met.",
    reg3Title: "Rules",
